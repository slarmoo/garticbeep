export class roundDates {
    ...
    readonly eventDates: Round[] = [
        ...
        { round: 1, time: [5, 3, 0], type: "song" }, 
        { round: 2, time: [5, 6, 0], type: "prompt" }, 
        { round: 2, time: [5, 9, 0], type: "song" }, 
        { round: 3, time: [5, 11, 0], type: "prompt" }, 
        { round: 3, time: [5, 14, 0], type: "song" },
        { round: 4, time: [5, 16, 0], type: "prompt" }, 
        { round: 4, time: [5, 19, 0], type: "song" }, 
        { round: 5, time: [5, 21, 0], type: "prompt" },
        { round: 5, time: [5, 24, 0], type: "song" }, 
        { round: 6, time: [6, 3, 0], type: "end" }, 
    ]
